...
const QString SettingsNames::composerDefaultKey = QLatin1String("composer/defaultKey");
const QString SettingsNames::composerEncryptDefault = QLatin1String("composer/encryptDefaut");
const QString SettingsNames::composerSignDefault = QLatin1String("composer/signDefault");
